...
function add_p_class(){
            ...
            $.ajax({
                type: 'POST',
                url: 'route/controller.php?action=add_third_map',
...
function gotolist(){
    ...
    else
    {
        $('#pClassTable').DataTable({
            "bProcessing": true,
            "sAjaxSource": "route/controller.php?action=load_third_branch&ser="+id,
            "aoColumns": [
                { "mData": "num"},
				{ "mData": "id_content",
                    "mRender":function(val,type,row){
                        return "<a href=\"./mind_map?param1=branch4&ser="+ val.split('-')[0] +"\">"+ val.split('-')[1] +"</a>";
                    }
                },
                { "mData": "EDITOR"},
...
//                alert(data.errmsg);
              ...
              break;
              case "success":  
				var content = '<li class="active"><a href ="mind_map?param1=branch1">心智圖管理 </a></li> <li><a href = \'mind_map?param1=branch2&ser='+postData[0].second_itemno.split('-')[0] +'\'>'+postData[0].second_itemno.split('-')[1]+' </a></li> <li><a href = \'mind_map?param1=branch3&ser='+postData[0].third_itemno.split('-')[0] +'\'>'+postData[0].third_itemno.split('-')[1]+' </a></li>';
