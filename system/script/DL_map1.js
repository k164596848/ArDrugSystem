        ...
        postData = data.data;
        	switch(postData[0].total)
        	{
        		case '3':
        			if(block==3)
        			{
        				window.location.href='./DownL?param1=F4BDL2_3&upser='+B3+'';
        			}
        			if(block==2)
        			{
        				window.location.href='./DownL?param1=F4BDL2_3&upser='+B2+'';
        			}
        			if(block==1)
        			{
        				window.location.href='./DownL?param1=F4BDL2_3&upser='+B1+'';
        			}
        			break;
        		case '2':
        			if(block==3)
        			{
        				window.location.href='./DownL?param1=F4BDL2_2&upser='+B3+'';
        			}
        			if(block==2)
        			{
        				window.location.href='./DownL?param1=F4BDL2_2&upser='+B2+'';
        			}
        			if(block==1)
        			{
        				window.location.href='./DownL?param1=F4BDL2_2&upser='+B1+'';
        			}
        			break;
        		case '1':
        			if(block==3)
        			{
        				window.location.href='./DownL?param1=F4BDL2_1&upser='+B3+'';
        			}
        			if(block==2)
        			{
        				window.location.href='./DownL?param1=F4BDL2_1&upser='+B2+'';
        			}
        			if(block==1)
        			{
        				window.location.href='./DownL?param1=F4BDL2_1&upser='+B1+'';
        			}
        			break;
        	}
        break;
